...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--arch=x86 --enable-gpl --enable-nonfree --enable-version3 --enable-shared --disable-static --enable-debug --enable-cuda --enable-cuvid --enable-nvenc --cpu=native --extra-cflags='-IC:/msys32/1.0/local/include' --extra-ldflags='-LIBPATH:C:/msys32/1.0/local/lib' --toolchain=msvc
prefix=/usr/local
...
CC_IDENT=用于 x86 的 Microsoft (R) C/C++ 优化编译器 18.00.40629 版版权所有(C) Microsoft Corporation。  保留所有权利。
ARCH=x86
INTRINSICS=none
CC=cl
CXX=g++
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -Dsnprintf=avpriv_snprintf -D_snprintf=avpriv_snprintf -Dvsnprintf=avpriv_vsnprintf -D_USE_MATH_DEFINES -D_CRT_SECURE_NO_WARNINGS -D_CRT_NONSTDC_NO_WARNINGS -D_WIN32_WINNT=0x0502 -I$(SRC_PATH)/compat/atomics/win32
CFLAGS= -nologo -IC:/msys32/1.0/local/include    -Z7 -W4 -wd4244 -wd4127 -wd4018 -wd4389 -wd4146 -wd4057 -wd4204 -wd4706 -wd4305 -wd4152 -wd4324 -we4013 -wd4100 -wd4214 -wd4307 -wd4273 -wd4554 -wd4701 -O2   -Oy- -Dinline=__inline
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
OBJCFLAGS= -nologo 
ASFLAGS= -nologo -IC:/msys32/1.0/local/include  -Z7
AS_C=-c
AS_O=-Fo$@
OBJCC_C=-c
OBJCC_E=-E -o $@
...
DEPWINDRES=cl
DOXYGEN=doxygen
LDFLAGS= -LIBPATH:C:/msys32/1.0/local/lib -nologo  -debug
LDEXEFLAGS=
LDLIBFLAGS=
...
HOSTCC=cl
HOSTLD=cl
HOSTCFLAGS= -nologo  -W4 -wd4244 -wd4127 -wd4018 -wd4389 -wd4146 -wd4057 -wd4204 -wd4706 -wd4305 -wd4152 -wd4324 -we4013 -wd4100 -wd4214 -wd4307 -wd4273 -wd4554 -wd4701 -O3 -Dinline=__inline
HOSTCPPFLAGS= -D_ISOC99_SOURCE -Dsnprintf=_snprintf -D_USE_MATH_DEFINES -D_CRT_SECURE_NO_WARNINGS -D_CRT_NONSTDC_NO_WARNINGS -D_WIN32_WINNT=0x0502
HOSTEXESUF=.exe
HOSTLDFLAGS= -nologo
HOSTLIBS=-lm
DEPHOSTCC=cl
